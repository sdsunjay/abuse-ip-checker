...
def test_get_api_key_from_file(monkeypatch, tmp_path):
...
def test_get_api_key_env_overrides_file(monkeypatch, tmp_path):
...
def test_get_api_key_no_config_file(monkeypatch, tmp_path):
